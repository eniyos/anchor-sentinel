/* @ts-self-types="./anchor_sentinel.d.ts" */
 ...
 * @param {string} idl_json
 * @param {string} rust_src
 * @returns {any}
 */
export function scan(idl_json, rust_src) {
    const ptr0 = passStringToWasm0(idl_json, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(rust_src, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.scan(ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anchor_sentinel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
